...
def update_policy(policy_net, policy_gradient, learning_rate=0.01):
    # Zero the gradients
...
def run_mountain_car(env_name='MountainCar-v0', num_episodes=1000, gamma=0.99, lr=0.01, window_size=10):
    ...
    for episode in range(num_episodes):
        ...
        policy_gradient = compute_policy_gradient(states, actions, returns, policy_net)
        
        # Update policy
        update_policy(policy_net, policy_gradient, learning_rate=lr)
