...
class MCTSNode:
    ...
    def print_tree(self, level=0):
        indent = "    " * level
        print(f"{indent}Node(Action: {self.action}, Visits: {self.visits}, Value: {self.value})")
        for child in self.children:
...
class MCTS:
    ...
    def search(self, initial_state):
        ...
        # Print the tree at the end of each experiment
        print("Final tree for this experiment:")
...
mcts = MCTS(env, num_simulations=1000, convergence_threshold=0.001)
state, _ = env.reset()
done = False
